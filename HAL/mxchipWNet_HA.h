...
#define UAP_MASK_ADDRESS "10.10.10.1" 
...
#define CONFIG_DATA_SIZE (sizeof(mxchipWNet_HA_config_st)-8-sizeof(boot_table_t))
...
char* Get_mac( char* mac );
/**************************XPG*******************/

int MQTT_OtaHandle( unsigned char *buf,int Len, int socket_cloud );
void DRV_MainTimer(void);

/*0 or 1*/
void led(int onoff);  /*red led*/
void set_conncetion_status(int onoff); /*green led*/
